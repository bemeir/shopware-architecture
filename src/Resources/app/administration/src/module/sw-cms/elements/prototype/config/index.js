import template from './sw-cms-el-config-prototype.html.twig';

Shopware.Component.register('sw-cms-el-config-prototype', {
    template,
    ...
    computed: {
        textAreaContent: {
            ...
            set(value) {
                this.element.config.textAreaContent.value = value;
            },
        },

        position() {
            return this.element.config.position?.value || 'image-left'; // Default to 'image-left' if not set
        },
